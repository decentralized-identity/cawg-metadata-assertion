...
This reference SHALL constitute an attestation by the _link:++https://cawg.io/identity/1.1/#_named_actor++[named actor]_ of that _link:https://cawg.io/identity/1.1/[identity assertion]_ to the accuracy of the metadata provided.
