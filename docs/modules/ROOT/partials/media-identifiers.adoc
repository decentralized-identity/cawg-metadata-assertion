...
Such data sources SHOULD be unambiguously and publicly resolvable via an IETF-registered URN scheme, such as EIDR or DOI.
_(TO DO: Are these appropriate examples? If so, include links?)_
